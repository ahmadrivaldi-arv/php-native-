        ...
        <div class="row vh-100 d-flex justify-content-center align-items-center">
            <div class="col-md-7 col-lg-5">
                <div class="card shadow-lg no-border b-radius-10">
                    <div class="card-body">
                        <h3 class="text-primary mb-3 mt-4 text-center">REGISTER</h3>
                        <form action="" method="post">
                            <div class="mb-3">
                                <label for="full_name" class="form-label">Full Name:</label>
                                <input type="text" required class="form-control " placeholder="Ujang Sutisna" name="full_name" id="full_name" value="<?php if(isset($_POST['full_name'])) echo($_POST['full_name']);?>">
                            </div>
                            <div class="mb-3">
                                <label for="user_email" class="form-label">Email:</label>
                                <input type="email" required class="form-control " placeholder="email@address.com" name="user_email" id="user_email" value="<?php if(isset($_POST['user_email'])) echo($_POST['user_email']);?>">
                            </div>
                            <div class="mb-3">
                                <label for="user_password" class="form-label">Password:</label>
                                <input type="password" required class="form-control " placeholder="*********" name="user_password" id="password">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" required class="form-control " placeholder="**********" name="user_password2" id="password2">
                                <div class="invalid-feedback" id="invalid">password not match</div>
                            </div>
                            <div class="mb-3">
